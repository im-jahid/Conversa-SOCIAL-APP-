    ...
    <>
      {
        cancel ?
          navigate('/home')
          :
          <div className='bg-[#EEEAEA] h-screen'>
            <div className='h-[400px] w-[450px] bg-[#06141D] flex justify-center items-center'>
              <div className='bg-[#06141D] py-[40px] pl-[90px] pr-[100px] rounded-lg text-center mt-[400px] relative'>
                ...
                <div className='flex justify-between'>
                  ...
                  <div className='w-[150px] h-[150px] object-cover overflow-hidden rounded-full'>
                    <div
